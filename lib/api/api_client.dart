...
class ApiClient {
  static const baseUrl = 'https://api.yourrestaurant.com';
    ...
    "items": [
      {
        ...
        "price": 5.99, "category_id": 1, "image_url": null,
        "customization_groups": [
          {
            "id": 1, "name": "Seasoning", "required": false, "max_selections": 2,
            "options": [
      ...
      {
        "id": 2, "name": "Salmon Sashimi",
        "description": "Fresh Norwegian salmon, 8 pieces",
        "price": 16.99, "category_id": 2, "image_url": null,
        "customization_groups": [
          {
            "id": 2, "name": "Size", "required": true, "max_selections": 1,
            "options": [
      ...
      },
      {
        ...
        "price": 3.50, "category_id": 3, "image_url": null,
        "customization_groups": []
      },
      {
        "id": 4, "name": "Chicken Ramen",
        "description": "Rich chicken broth with chashu, egg, and noodles",
        "price": 14.99, "category_id": 2, "image_url": null,
        "customization_groups": [
          {
            "id": 3, "name": "Spice Level", "required": true, "max_selections": 1,
            "options": [
          ...
          {
            "id": 4, "name": "Add-ons", "required": false, "max_selections": 3,
            "options": [
  ...
  static Future<Map<String, dynamic>> fetchMenu(String tableId) async {
    try {
      final uri = Uri.parse('$baseUrl/api/v1/menu?table_id=$tableId');
  ...
  static Future<Order> fetchOrderStatus(String orderId) async {
    try {
    ...
    final statuses = OrderStatus.steps;
    final idx = (DateTime.now().second ~/ 10).clamp(0, statuses.length - 1);
    return Order.fromJson({
      'id': orderId,
      'table_id': 'T001',
      'status': statuses[idx],
